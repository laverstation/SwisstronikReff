...
async function main() {
    ...
    const contractAddress = "0x080b4873C6F0215D92A66ead5083f44d5AC7178F";
    ...
    const setMessageTx = await sendShieldedTransaction(signer, contractAddress, contract.interface.encodeFunctionData("setMessage", ["Hello Swisstronik, This is Naufalaver!!"]), 0);
